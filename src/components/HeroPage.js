...
export default function HeroPage({ contactRef }) {
	...
	return (
		<div className="flex items-center justify-center px-3 mx-auto md:pt-12 bg-none w-fu md:px-16">
			<div className="flex flex-col items-center justify-center gap-3 px-6 pt-6 md:gap-7 md:flex-row">
				...
				>
					<p className="text-2xl font-bold sm:px-10 md:px-2 md:text-3xl text-sky-950">
						<h1 className="text-xl">Heloo,</h1>
